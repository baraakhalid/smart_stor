  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Reset Password',style: TextStyle(color: Color(0XFF8B8B8B),fontSize: 18),),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Set the new password for your account and you can access all the features.',style: TextStyle(color: Color(0XFF8B8B8B)),
